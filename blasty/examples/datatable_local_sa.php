...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>Datatable stand-alone example (local) : PHP Blasty Examples</title>
  ...
  <body class="yui-skin-sam">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
      <tr>
        <td id="breadcrumb"><a href="index.php">PHP Blasty Example start page</a> &nbsp;&#8250;&nbsp;
          Datatable stand-alone example (local)
        </td>
    ...
    <div id="ug-content">
      ...
      <h1>Datatable stand-alone example (local)</h1>
      <p>
      </p>
    ...
    <div id="footer">
      <p>
        Previous Topic:&nbsp;&nbsp;<a href="calendar_sa.php">Calendar stand-alone example</a>
        &nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        <a href="#top">Top of Page</a>&nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        <a href="../user_guide/index.html">PHP Blasty User Guide</a>&nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        Next Topic:&nbsp;&nbsp;<a href="datatable_remote_sa.php">Datatable stand-alone example (remote)</a>
      </p>
