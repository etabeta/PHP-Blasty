<?php
  ...
  $autocomplete->setLiveData('usa_state.php');                                  // Provide remote data
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>Autocomplete stand-alone example (remote) : PHP Blasty Examples</title>
  ...
  <body class="yui-skin-sam">
    ...
    <div id="footer">
      <p>
        Previous Topic:&nbsp;&nbsp;<a href="autocomplete_local_sa.php">Autocomplete stand-alone example (local)</a>
        &nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        <a href="#top">Top of Page</a>&nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        <a href="../user_guide/index.html">PHP Blasty User Guide</a>&nbsp;&nbsp;&nbsp;&middot;&nbsp;&nbsp;
        Next Topic:&nbsp;&nbsp;<a href="calendar_sa.php">Calendar stand-alone example</a>
      </p>
