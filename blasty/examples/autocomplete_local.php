...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>Autocomplete nested example (local) : PHP Blasty Examples</title>
  ...
  <body class="yui-skin-sam">
    ...
    <div id="ug-content">
      ...
      <h1>Autocomplete nested example (local)</h1>
      <p>
      </p>
    ...
    <div id="footer">
      <p>
        ...
        Next Topic:&nbsp;&nbsp;<a href="autocomplete_remote.php">Autocomplete nested example (remote)</a>
      </p>
